/**
 * Evidence-capture helper for #653 (TEST-006): create the packed release
 ...
 *
 * Rerun:
 *   bun run docs/reviews/evidence/2026-09-23-terminal-recapture/prepare-candidate.ts <destination>
 */
...
if (destination === undefined || destination.length === 0) {
  throw new Error(
    "usage: bun run docs/reviews/evidence/2026-09-23-terminal-recapture/prepare-candidate.ts <destination-directory>",
  );
}
