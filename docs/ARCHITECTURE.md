...
its Installation ID, lifetime (`ordinary` or `temporary`, with an optional
`retired` flag set by `unbind`), canonical Project, Profile ID, desired-input
digest, Host receipt map, and generated output roots. Receipts record no
