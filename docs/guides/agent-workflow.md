...
5. Validate before applying. Context Modules use `id` frontmatter and flat
   ...
   use explicit `{ type, id }` references. The project-bound slice accepts
   Context and Skills for Codex and Claude and rejects Profiles selecting
   Agents, Hooks, or Tools.
