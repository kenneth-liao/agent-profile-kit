...
export const COMMANDS: readonly CommandHelp[] = [
  ...
  },
  {
    ...
    summary: "Sync the current Project, one explicit Project, or the complete fleet; --blockers-only shows a focused Blocker-only view that always keeps the Applied receipt and failed or pending Projects visible (combines with --verbose, not --json)",
